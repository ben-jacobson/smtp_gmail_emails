# I was having some difficulties connecting a Django app to smtp.gmail.com when running example code from tdd-book.
# This piece of code is just a hacky test. Mainly to help diagnose the issue with Django's send_mail functionality. Turns out the built-in doens't do SSL to well. and Gmail prefers SSL over TLS..
...
# Instructions:
# - First set environment variables EMAIL_HOST_USER and EMAIL_PASSWORD. eg $ export EMAIL_PASSWORD=*insert your password here*
...
# - Run this with $ python smtp_gmail_emails.py email@emailaddress.com
